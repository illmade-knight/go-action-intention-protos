...
func (*NotificationRequestPb_Content) Descriptor() ([]byte, []int) {
	return file_proto_notification_v1_notification_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_proto_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"(proto/notification/v1/notification.proto\x12 action_intention.notification.v1\"A\n" +
